...
-- 1. Trigger Function for Enquiries (Using info@victasure.com to info@victasure.com)
  ...
  PERFORM
    net.http_post(
      ...
      body := jsonb_build_object( -- body as pure jsonb
        'from', 'VictaSure Portal <info@victasure.com>', -- Changed from portal@victasure.com to info@victasure.com
...
-- 2. Trigger Function for Catalogue Downloads (Using info@victasure.com to info@victasure.com)
